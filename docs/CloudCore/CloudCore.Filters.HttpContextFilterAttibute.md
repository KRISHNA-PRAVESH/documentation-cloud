#  Class HttpContextFilterAttibute

Namespace: [CloudCore.Filters](CloudCore.Filters.md)  
Assembly: CloudCore.dll  

```csharp
public class HttpContextFilterAttibute : ActionFilterAttribute, IActionFilter, IAsyncActionFilter, IResultFilter, IAsyncResultFilter, IOrderedFilter, IFilterMetadata
```
...
`actionContext` [ActionExecutingContext](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.mvc.filters.actionexecutingcontext)
