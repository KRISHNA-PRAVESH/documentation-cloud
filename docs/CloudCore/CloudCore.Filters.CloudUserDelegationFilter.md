#  Class CloudUserDelegationFilter

Namespace: [CloudCore.Filters](CloudCore.Filters.md)  
Assembly: CloudCore.dll  

```csharp
public class CloudUserDelegationFilter : ActionFilterAttribute, IActionFilter, IAsyncActionFilter, IResultFilter, IAsyncResultFilter, IOrderedFilter, IFilterMetadata
```
...
The <xref href="Microsoft.AspNetCore.Mvc.Filters.ActionExecutingContext" data-throw-if-not-resolved="false"></xref>.
