...
```csharp
public static WebApplication ConfigureHttpPipeLine(this WebApplication webApplication, string? DefaultController = null)
```

#### Parameters

`webApplication` [WebApplication](https://learn.microsoft.com/dotnet/api/microsoft.aspnetcore.builder.webapplication)

`DefaultController` [string](https://learn.microsoft.com/dotnet/api/system.string)?
