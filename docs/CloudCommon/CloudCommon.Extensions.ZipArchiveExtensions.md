...
`archiveName` [string](https://learn.microsoft.com/dotnet/api/system.string)

`destinationDirectoryName` [string](https://learn.microsoft.com/dotnet/api/system.string)
...
`archive` [ZipArchive](https://learn.microsoft.com/dotnet/api/system.io.compression.ziparchive)
